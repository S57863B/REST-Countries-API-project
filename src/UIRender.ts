...
export class UIRenderer {
    ...
    public renderHomePageLayout(): void {
        // Check if the layout already exists to avoid re-rendering it on search
        if (document.getElementById('countries-grid')) return;
  ...
  public renderCountriesList(countries: Country[], onCardClick: (code: string) => void): void {
